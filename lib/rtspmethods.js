...
module.exports = function(rtspServer) {
  ...
  var options = function(req, res) {
    ...
    if (req.getHeader('Apple-Challenge')) {
      ...
      var ipAddr = new Buffer(rtspServer.ipAddress ? ip.toBuffer(rtspServer.ipAddress) : ip.toBuffer(ip.address()), 'hex');
